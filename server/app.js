...
wssServer.on("connection", function(ws) {
  util.log(
    "Connection from " + util.inspect(ws.upgradeReq.connection.remoteAddress)
  );
  ws.send(
    "Hello from Leadin chat. Set the nickname with the command /nick nickname before chatting away."
  );
